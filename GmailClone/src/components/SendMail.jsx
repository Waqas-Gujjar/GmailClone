...
const SendMail = () => {
  ...
  return (
   <div className={`${open ? "block" : "hidden"} bg-white max-w-8xl shadow-xl shadow-slate-600 rounded-t-md`}>
        ...
        <div className='flex px-3 py-2 bg-[#F2F6Fc] justify-between rounded-t-md'>
            ...
            <div onClick={()=>dispatch(setOpen(false))} className=' gap-3 flex '>
                ...
                <RxCross2 size={"16px"} className='rounded-full hover:bg-gray-200 cursor-pointer' />
        ...
        <form action="" className=' flex flex-col p-3 gap-2'>
            ...
            <div className='flex items-center '>
                 <button type='submit' className=' cursor-pointer rounded-l-full px-1 w-18 h-9 text-white font-medium bg-[#0B57D0] '>Send</button>
                <button type='submit' className=' items-center px-1 cursor-pointer rounded-r-full w-8 border-l-2 border-gray-500 h-9  text-white font-medium bg-[#0B57D0] '><FaCaretDown /></button>
